    ...
    def generate_chart(filtered_data, filter_store, color_mode):
        ...
        if use_adaptive:
            note_text = (
                ...
                "The colour scale runs from the 1st to the 99th percentile of consensus scores across the "
                f"selected resolutions ({lo:.2f}–{hi:.2f}), and its midpoint (yellow) is anchored at the average "
                f"consensus score ({avg:.2f})."
