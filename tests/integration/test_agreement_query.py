...
def test_vote_columns_are_categorical(engine):
    ...
    Regression guard: if the cast in DataRepository._build_resolution_table is ever removed or
    bypassed, this test fails immediately rather than silently restoring ~150 MB of unnecessary
